          ...
          <div class="tile is-parent">
            <article class="tile is-child notification is-normal">
              <div class="content">
                ...
                <p>
                  偶然发现了bulma，自然语义定义的方式让人耳目一新，特别gzip后13.6k的size令人印象深刻，刚好基于vue+weui的移动端组件库demo已经接近完成，于是便抽空做了这套基于vue+bulma的轻量级UI。既然是后台管理UI，便可以任性的对IE无视，此处应有掌声。</p>
          ...
          <div class="tile is-parent">
            <article class="tile is-child notification is-normal">
              <div class="content">
                ...
                <p>
                  想让系统更加顺畅，缓存必不可少，vue-bulma中除了vue内置的keep-alive对dom进行缓存外，同时具备ajax的数据缓存机制。另外，还准备了manifest缓存指引，让前端飞起来。。。</p>
                <div class="content">
                  <!-- Content -->
                </div>
              </div>
...
<style lang="less" scoped>
  .tabs-content-container .fade-leave-active {
    display: none;
  }
  .tabs-content-container .fade-enter {
